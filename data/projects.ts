...
export const sideProjects: SideProject[] = [
  ...
  },
  {
    ...
    featured: true,
    description:
      'Production-ready multi-cloud MLOps platform on AWS EKS and Azure AKS with defense-in-depth security. Enables data science teams to deploy ML models and LLMs from experimentation to production in 15 minutes with full auditability, drift detection, and GitOps-driven infrastructure.',
    technologies: [
      'Argo Workflows',
      'MLflow 3.x',
      'KServe',
    ...
    goals: [
      ...
      'Multi-cloud deployment: AWS EKS with Karpenter, Azure AKS with KEDA',
      ...
      'Cost optimization: 60% GPU savings with SPOT instances and intelligent autoscaling',
    ],
    milestones: [
