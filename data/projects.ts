...
export const sideProjects: SideProject[] = [
  ...
  },
  {
    ...
    goals: [
      ...
      'Full-stack observability: Prometheus metrics, Grafana dashboards, Loki logs, Tempo traces, and OpenTelemetry instrumentation',
      ...
      'Automated CI/CD: linting, testing, security scanning, and parallel Terraform plans across all clouds',
      'Network observability with VPC Flow Logs (AWS), NSG Flow Logs with Traffic Analytics (Azure), and GCP Flow Logs',
      'Disaster recovery with AWS Backup (daily/weekly schedules) and automated RDS snapshots',
      'Resilience testing with Chaos Mesh: pod failure, network chaos, CPU/memory stress experiments',
    ],
    milestones: [
