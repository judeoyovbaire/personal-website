...
import { MapPin, Building, Target, Sparkles, Mail, ExternalLink } from 'lucide-react'
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mb-16">
          ...
          <div className="flex flex-wrap gap-4 text-sm text-gray-600 dark:text-gray-400 mb-8">
            ...
            <div className="flex items-center gap-2">
              <Target size={16} />
              <span>Open to: Engineering Manager, Staff+ Roles</span>
            </div>
          </div>

          <div className="flex gap-4">
            <a
              href="mailto:jude@nubescode.com"
        ...
        <section className="my-12 p-6 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-gray-800 dark:to-gray-900 rounded-xl">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-white mb-2">🎯 Searching</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Actively exploring Engineering Manager and Staff+ positions in Amsterdam/Remote EU
              </p>
            </div>
            <div>
